...
{
    public class CreateStudentMarkRequestValidator : AbstractValidator<CreateStudentMarkRequest>
    {
        public CreateStudentMarkRequestValidator()
        {
            ...
            // If not absent, obtained marks should be provided
            RuleFor(x => x.ObtainedMarks)
                .NotNull().WithMessage("Obtained marks is required when student is not absent")
                .When(x => !x.IsAbsent);
