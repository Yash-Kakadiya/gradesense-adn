...
{
    public class UpdateAssessmentItemRequestValidator : AbstractValidator<UpdateAssessmentItemRequest>
    {
        public UpdateAssessmentItemRequestValidator()
        {
            ...
            RuleFor(x => x.CalculationType)
                ...
                .When(x => !string.IsNullOrEmpty(x.CalculationType));
